...
✅ **Two-Device Architecture** — नियंत्रक (Controller, minimalist) + दर्शक (Audience
Display, rich) — Cloudflare Pages Functions (`/api/sync`, `/api/viewers`) द्वारे sync
✅ **अनेक दर्शक + उपस्थिती-यादी** — नियंत्रकाला कोण-कोण दर्शक-मोडमध्ये जोडलेले आहे ते दिसते
(heartbeat-आधारित उपस्थिती, दर ३ सेकंदांनी अद्ययावत)
...
✅ **पूर्ण मंत्र + सोपे मराठी अर्थ + कथा** — १४१ पायऱ्या, १२७ मंत्र, पाच अध्यायांची
सत्यनारायण कथा
✅ **Video स्रोत निवड (R2/YouTube)** — विष्णुसहस्रनाम ८व्या सेकंदापासून सुरू
✅ **Guide Mode** — Step-by-step मार्गदर्शन, ऑडिओसह
✅ **Offline-First** — सर्व MP3 files cache होतात
✅ **मोबाईल-फर्स्ट** — dvh वापरून 100vh बग दुरुस्त, touch-scroll समस्या दुरुस्त, portrait
मध्ये नैसर्गिक page-scroll (sticky header/footer)
